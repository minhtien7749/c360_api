...
public class CreditApprovalQuery {
    ...
    String QUERY_FROM_TO = "with cif_tbl as (\n" +
            ...
            "            from customer360.c360_loan_disbursement_transaction_dly\n" +
            ...
            "   from customer360.c360_lon_dtls_fact " +
            "            where cob_dt = ? /*to_dt*/\n" +
            "               AND cus_cif_nbr = ? /*cif*/\n" +
            "            )\n" +
            "        , tf_tbl as (\n" +
            ...
            "            from tradefinance.trd_fin_trns_dtls_amt\n" +
            "            where cob_dt between ? /*from_dt*/ and ? /*to_dt*/\n" +
            ...
            "            from customer360.c360_cus_toi_amt_fact\n" +
